            ...
            <div className="text-center mb-12 md:mb-16">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#293681] tracking-tight">
                    ...
                    <span className="relative inline-block">
                        ...
                        <svg className="absolute left-0 bottom-[-8px] w-full h-2 text-[#3881f5]" viewBox="0 0 100 10" preserveAspectRatio="none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 flex flex-col space-y-8 order-2 lg:order-1">
                    <div className="space-y-8 max-w-xl mx-auto lg:mx-0">
                        {features.map((feature, index) => (
                            <div key={index} className="flex gap-4 items-start">
                                ...
                                <CheckCircle2 className="w-6 h-6 text-[#293681] flex-shrink-0 mt-0.5" />
                                
                                <div className="space-y-1.5">
                                    <h3 className="text-base md:text-lg font-bold text-[#293681]">
                                        {feature.title}
                                    </h3>
                    ...
                    <div className="pt-4 text-center lg:text-left">
                        <button className="w-full sm:w-auto bg-[#3881f5]  text-white font-bold text-base px-10 py-3.5 rounded-md shadow-md hover:shadow-lg active:scale-98 transition-all duration-200 cursor-pointer">
                            Get Started
                        </button>
                    </div>
                </div>
                ...
                <div className="lg:col-span-5 flex justify-center order-1 lg:order-2">
                    <div className="relative w-70 h-70 sm:w-85 sm:h-85 md:w-95 md:h-95">
                        ...
                        <div className="absolute inset-0 bg-[#293681] rounded-[40%_60%_70%_30%_/_40%_50%_60%_50%] opacity-90 "></div>
